...
const MODULES = [
  ...
  { id:"m7", day:"PPF Upsell", title:"RMA PPF — Protection Packages & Upsell Training", phase:2, defaultUnlocked:false, items:[
    "Understand that RMA PPF is a key upsell/SPV opportunity on every vehicle sale — always introduce it as part of the appointment conversation",
    "Three protection packages: Essential, Elite, and Signature — know the differences and when to recommend each",
    "Essential: Full Body PPF. Good entry-level protection for budget-conscious buyers",
    "Elite: Full Body PPF + Interior PPF + Leather & Fabric Coating + Window Tint + Halo Ceramic Coating + Glass Ceramic Coating + Wheel Armour + 0% Windscreen Film. Saves customer over AED 4,000 vs buying separately. 10-year warranty.",
    "Signature: Everything in Elite PLUS Windscreen Protection Film + Panoramic Sunroof Protection + 12 RMA Safe Washes + 5 PPF Panel Replacements in 12 months. Over AED 10,000 in extra value. 10-year warranty.",
    "Pricing by vehicle type — Coupe: Essential AED 14,000 / Elite AED 17,950 / Signature AED 22,950",
    "Pricing by vehicle type — Small SUV/Saloon: Essential AED 14,495 / Elite AED 18,950 / Signature AED 23,950",
    "Pricing by vehicle type — Large SUV: Essential AED 16,950 / Elite AED 20,950 / Signature AED 26,950",
    "Pricing by vehicle type — Hypercar/Exotic: Essential AED 19,000 / Elite AED 23,950 / Signature AED 28,950",
    "Shogun PPF product range: engineered and tested for the Middle East climate — heat, UV, sand, and road debris. TPU film produced in Nagoya, Japan.",
    "Gloss films: Shogun X8 Plus (SIGNATURE PRODUCT — 10-year warranty, >90 GU gloss, anti-yellowing), Shogun Track (racing, 9.7mil thick), Shogun Obsidian Black (stylish black gloss), Shogun X7 (quality + affordability)",
    "Matte films: Shogun Matte (pure matte, <20 GU), Shogun Kuro Matte (stealth black), Shogun Satin (smooth, 20–30 GU)",
    "Specialist films: Shogun Panorama (glass sunroof protection, 98% UV rejection), Shogun WPF-7 (windshield protection, shatter-resistant, self-healing)",
    "All Shogun PPF: 10-year warranty against fading, bubbling, discolouration, cracking, peeling, and adhesion failure",
    "Key upsell conversation: 'While you're here, I'd love to show you our RMA PPF options — most of our buyers add protection to keep the car in showroom condition. The Elite package saves you over AED 4,000 compared to buying separately and comes with a 10-year warranty.'",
    "The best price will only be discussed in person — introduce PPF during the appointment and hand to the PPF team for full consultation",
  ] },
...
export default function App() {
  ...
  const isUnlocked = (mod, done=[]) => {
    ...
    const order = ["m1","m2","m3","m4","m5","m7","m6"];
